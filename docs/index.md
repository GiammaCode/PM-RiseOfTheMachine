...
1. [Contesto del Progetto](descrizione/1-contesto.md)
2. [Scoping-Initiating](descrizione/2-scoping-initiating.md)
3. [Planning](descrizione/3-planning.md)
4. [Execution](descrizione/4-execution.md)
5. [Monitoring](descrizione/5-monitoring.md)
6. [Closing](descrizione/6-closing.md)

## Documentazione Tecnica

- [CoS - Conditions of Satisfaction](documentazione/cos_conditions_satisfaction.md)
- [RBS - Requirements Breakdown Structure](documentazione/rbs_requirements_breakdown.md)
- [SWOT analysis](documentazione/SWOT_analysis.md)
